...
import { commented, getComment, getValue } from "./fonction/fonction";
  ...
  return (
    <View style={styles.modal}>
      <View style={styles.commentHeader}>
        <Text style={styles.commentHeaderText}>Publication de {username}</Text>
      </View>
      <ScrollView>
      ...
      {photo && (
        <View style={{ width: 100, height: 100 }}>
          <Pressable onPress={() => setPhoto(null)} style={styles.trashIcon}>
